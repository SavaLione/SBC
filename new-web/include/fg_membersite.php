...
class FGMembersite
{
    ...
    function InsertIntoDB(&$formvars)
    {
        ...
        $insert_query = 'insert into ' . $this->tablename . '(
            ...
            "' . $encrypted_password . '",
            "' . $confirmcode . '",
            "user_table_' . $this->SanitizeForSQL($formvars['username']) . '"
            )';
        ...
        $create_user_table = 'create table user_table_' .$this->SanitizeForSQL($formvars['username']) . ' (' .
            'id_user INT NOT NULL AUTO_INCREMENT ,' .
            'lat INT NOT NULL ,' .
            'lon INT NOT NULL ,' .
        ...
        $this->HandleDBError("Error inserting data to the user_table\nquery:$create_user_table");

        if (!mysqli_query($this->connection, $create_user_table)) {
            $this->HandleDBError("Error inserting data to the user_table\nquery:$create_user_table");
            return false;
        }
